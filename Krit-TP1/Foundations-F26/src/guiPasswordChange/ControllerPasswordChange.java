...
public class ControllerPasswordChange {
	...
	*/
	...
	protected static void doLogin(Stage ts) {
		theStage = ts;
		String username = ViewPasswordChange.text_Username.getText();
		String password = ViewPasswordChange.text_Password.getText();
		...
		// Fetch the user and verify the username
     	if (theDatabase.getUserAccountDetails(username) == false) {
    		...
    		ViewPasswordChange.alertUsernamePasswordError.setContentText(
    				"Incorrect username/password. Try again!");
    		ViewPasswordChange.alertUsernamePasswordError.showAndWait();
    		return;
    	}
