...
public class ViewFirstAdmin {
	...
	// for the user to specify a username for this account (it must be valid) and two copies of the
	// password to be used (they must match), a button to request that the account be established,
	// and a quit button to abort the action and stop the application.
	...
	private ViewFirstAdmin() {
		...
		theRootPane.getChildren().addAll(label_ApplicationTitle, label_TitleLine1,
				...
				text_AdminPassword2, button_AdminSetup, label_UsernameInvalid, label_PasswordsDoNotMatch,
				button_Quit);
	}
