	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				// The current character is checked against A-Z, a-z. If any are matched the FSM
				// goes to state 1
			...
			case 1: 
				...
				//  2: a period, hyphen, underscore, or ampersand that transitions to state 2
			...
			case 2: 
				// State 2 deals with a character after a period, hyphen, underscore, or ampersand
				// in the name.
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a period, hyphen, underscore, or ampersand must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
