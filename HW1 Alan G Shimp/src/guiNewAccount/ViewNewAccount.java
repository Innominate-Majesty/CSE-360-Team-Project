...
public class ViewNewAccount {
	...
	*/
	...
	// This alert is used should the user enter an empty string as a username
    protected static Alert alertUsernameInputEmpty = new Alert(AlertType.INFORMATION);
    
    // This alert is used should the user enter a username with an invalid leading character
    protected static Alert alertUsernameFirstCharIsInvalid = new Alert(AlertType.INFORMATION);
    
    // This alert is used should the user enter a username where a period, hyphen, underscore, or
    // ampersand is not followed by an alphanumeric character
    protected static Alert alertUsernamePunctuationError = new Alert(AlertType.INFORMATION);
    
    // This alert is used should the user enter a username with an invalid character
    protected static Alert alertUsernameCharIsInvalid = new Alert(AlertType.INFORMATION);
    
    // This alert is used should the user enter a username that is too short
    protected static Alert alertUsernameTooShort = new Alert(AlertType.INFORMATION);
    
    // This alert is used should the user enter a username that is too long
    protected static Alert alertUsernameTooLong = new Alert(AlertType.INFORMATION);
	...
	*/
	...
	private ViewNewAccount() {
		...
		// If the username input is empty, this alert dialog will tell the user
		alertUsernameInputEmpty.setTitle("Input Is Empty");
		alertUsernameInputEmpty.setHeaderText("*** ERROR *** The input is empty");
		alertUsernameInputEmpty.setContentText("Correct the username and try again.");
		
		// If the username input has an invalid leading character, this alert dialog will tell the
		// user
		alertUsernameFirstCharIsInvalid.setTitle("Invalid First Character");
		alertUsernameFirstCharIsInvalid.setHeaderText("*** ERROR *** A UserName must start with "
				+ "A-Z or a-z.");
		alertUsernameFirstCharIsInvalid.setContentText("Correct the username and try again.");
		
		// If the username input has a punctuation mark not followed by an alphanumeric character,
		// this alert dialog will tell the user
		alertUsernamePunctuationError.setTitle("Punctuation Not Followed By Alphanumeric");
		alertUsernamePunctuationError.setHeaderText("*** ERROR *** A UserName character after a "
				+ "period, hyphen, underscore, or ampersand must be A-Z, a-z, 0-9.");
		alertUsernamePunctuationError.setContentText("Correct the username and try again.");
		
		// If the username input includes an invalid character, this alert dialog will tell the
		// user
		alertUsernameCharIsInvalid.setTitle("Invalid Character");
		alertUsernameCharIsInvalid.setHeaderText("*** ERROR *** A UserName character may only "
				+ "contain the characters A-Z, a-z, 0-9.");
		alertUsernameCharIsInvalid.setContentText("Correct the username and try again.");
		
		// If the username input is too short, this alert dialog will tell the user
		alertUsernameTooShort.setTitle("Input Too Short");
		alertUsernameTooShort.setHeaderText("*** ERROR *** A UserName must have at least 4 "
				+ "characters.");
		alertUsernameTooShort.setContentText("Correct the username and try again.");
		
		// If the username input is too long, this alert dialog will tell the user
		alertUsernameTooLong.setTitle("Input Too Long");
		alertUsernameTooLong.setHeaderText("*** ERROR *** A UserName must have no more than 32 "
				+ "characters.");
		alertUsernameTooLong.setContentText("Correct the username and try again.");
