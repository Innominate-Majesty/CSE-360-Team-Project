...
public class ViewFirstAdmin {
	...
	private ViewFirstAdmin() {
		...
		// Label to display the User Name Not Valid error message
		setupLabelUI(label_UserNameNotValid, "Arial", 18, width, Pos.CENTER, 0, 300);
		...
		theRootPane.getChildren().addAll(label_ApplicationTitle, label_TitleLine1,
				...
				text_AdminPassword2, button_AdminSetup, label_PasswordsDoNotMatch,label_UserNameNotValid,
				button_Quit);
	}
