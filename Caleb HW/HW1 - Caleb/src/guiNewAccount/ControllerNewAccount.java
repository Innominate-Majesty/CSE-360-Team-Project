...
public class ControllerNewAccount {
	...
	*/
	...
	protected static void doCreateUser() {
		...
		// Make sure the UserName is Valid. If not valid, clear password fields, and show error message in pop-up.
		...
		if (UserNameError  != "") {	
			...
			ViewNewAccount.alertIvalidUsernameError.setContentText(UserNameError);
			ViewNewAccount.alertIvalidUsernameError.showAndWait();
		}
		else {
