...
public class ViewNewAccount {
	...
	*/
	...
	protected static Alert alertIvalidUsernameError = new Alert(AlertType.INFORMATION);
	...
	*/
	...
	private ViewNewAccount() {
		...
		// If UserName is invalid, this alert dialog will tell the user
		alertIvalidUsernameError.setTitle("UserName Invalid");
		alertIvalidUsernameError.setHeaderText("The UserName provided is not Valid.");
