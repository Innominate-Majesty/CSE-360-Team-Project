...
/*******
 * <p>
 * Title: ControllerUserLogin Class.
 * </p>
 * 
 * <p>
...
public class ControllerUserLogin {
	...
	*/
	 ...
	 * button. This
	 * method checks the username and password to see if they are valid. If so, it
	 * then logs that
	...
	protected static void doLogin(Stage ts) {
		...
		if (tempPassword != null
				&& password.compareTo(tempPassword) == 0) {
	 ...
	 * button. Doing
	 * this terminates the execution of the application. All important data must be
	 * stored in the
	 * database, so there is no cleanup required. (This is important so we can
	 * minimize the impact
	 * of crashed.)
	 * 
	 */
