...
import guiNewAccount.UserNameRecognizer;
	...
	*/
	...
	protected static void doSetupAdmin(Stage ps, int r) {
		...
		if (errMessage != "") {
			...
			System.out.println(adminUsername.substring(0,UserNameRecognizer.userNameRecognizerIndexofError) + "\u21EB");
			
			// Display an Alert to the user and clear the username field
			ViewFirstAdmin.text_AdminUsername.setText("");
			ViewFirstAdmin.alertUsernameError.setHeaderText(errMessage);
