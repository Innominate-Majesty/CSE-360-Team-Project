...
public class ViewFirstAdmin {
	...
	// This alert is used should the user enter a username that isn't accepted
	...
	private ViewFirstAdmin() {
		...
		// If the username is not accepted, this alert dialog will tell the user
		alertUsernameError.setTitle("Invalid Username");
		alertUsernameError.setHeaderText("PLACEHOLDER TEXT");
