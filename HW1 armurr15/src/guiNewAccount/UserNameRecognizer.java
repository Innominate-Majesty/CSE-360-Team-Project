...
public class UserNameRecognizer {
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
						(currentChar >= 'a' && currentChar <= 'z' )	// Check for a-z
						 ) {	// Removed Check for 0-9 (currentChar >= '0' && currentChar <= '9' ))
					nextState = 1;
				...
				// If it is none of those characters, the FSM halts and issues a helpful error
				else 
					running = false;			
			...
			case 1: 
				...
				// . -> State 2
						...
						(currentChar == '&') ||   // Check for ampersand '&'
						(currentChar == '-') ||   // Check for dash (minus) '-'
						(currentChar == '_')) {	  // Check for underscore '_'					
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a symbol (period '.', ampersand '&', dash'-', or underscore '_') must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
